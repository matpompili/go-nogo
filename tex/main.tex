...
A Monte-Carlo simulation shows that, with current measurement uncertainties, we would need \todo{Make simulation}$??$ hours of data taking to show that the witness is negative with a statistical significance of $5\sigma$.
