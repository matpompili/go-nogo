...
\begin{table}
	...
	\todo[inline]{Add more relevant parameters}
\end{table}
...
A Monte-Carlo simulation shows that, with current experimental uncertainties, we would need \todo{Make simulation}$??$ hours of measurement to show that the witness is negative with a statistical significance of $5\sigma$.
